...
const NavBar = ({ activeIndex }) => {
  ...
  return (
    <NavContainer>
      <Nav>
        <NavItem active={currentIndex === 0} onClick={() => handleItemClick(0)}>
          {currentIndex === 0 && <Circle />}
          <StyledLink to="/home">홈</StyledLink>
        </NavItem>
        <NavItem active={currentIndex === 1} onClick={() => handleItemClick(1)}>
          {currentIndex === 1 && <Circle />}
          <StyledLink to="/search">검색</StyledLink>
        </NavItem>
        <NavItem active={currentIndex === 2} onClick={() => handleItemClick(2)}>
          {currentIndex === 2 && <Circle />}
          <StyledLink to="/order">주문내역</StyledLink>
        </NavItem>
        <NavItem active={currentIndex === 3} onClick={() => handleItemClick(3)}>
