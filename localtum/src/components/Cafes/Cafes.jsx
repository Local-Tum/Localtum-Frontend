...
const Cafes = [
  ...
  },
  {
    ...
    menu: [
      { name: "초코초코", image: coldbrew, price: "4500" },
      { name: "아메리카노", image: cappuccino, price: "4000" },
      { name: "카페라떼", image: flatwhite, price: "4500" },
      { name: "아메리카노;뉴문", image: housedolce, price: "5000" },
      { name: "로얄밀크티", image: einspanner, price: "4500" },
      { name: "비엔나라떼", image: caffelatte, price: "5500" },
      { name: "애플피치아이스티", image: housematcha, price: "5000" },
      { name: "아메리카노:이클립스(디카페인)", image: americano, price: "4500" },
      { name: "레몬에이드", image: housechoco, price: "5500" },
      { name: "아인슈페너", image: vanillalatte, price: "5500" },
      { name: "자몽에이드", image: housecream, price: "5500" },
      { name: "청포도에이드", image: milktea, price: "5500" },
    ],
  },
  {
    id: 3,
    ...
    menu: [
      { name: "헬싱키 라떼(시그니처)", image: coldbrew, price: "4800" },
      { name: "브리티시 아인슈페너", image: cappuccino, price: "4800" },
      { name: "스페니쉬 연유 라떼", image: flatwhite, price: "4800" },
      { name: "바닐라 라떼", image: housedolce, price: "4800" },
      { name: "카라멜 라떼", image: einspanner, price: "4800" },
      { name: "카페 모카", image: caffelatte, price: "4800" },
      { name: "플랫 그린", image: housematcha, price: "4800" },
      { name: "라떼", image: americano, price: "4300" },
      { name: "카푸치노", image: housechoco, price: "4300" },
      { name: "플랫 화이트", image: vanillalatte, price: "4100" },
      { name: "아메리카노", image: housecream, price: "3400" },
      { name: "아메리카노(디카페인)", image: milktea, price: "3900" },
      { name: "콜드브루 아인슈페너", image: housematcha, price: "4800" },
      { name: "콜드브루 연유라떼", image: americano, price: "5200" },
      { name: "콜드브루 바닐라라떼", image: housechoco, price: "5200" },
      { name: "100% 토마토 주스", image: vanillalatte, price: "5800" },
      { name: "생착즙 에이드(레몬)", image: housecream, price: "4800" },
      { name: "생착즙 에이드(자몽)", image: milktea, price: "4800" },
      { name: "골든 아쌈 밀크티", image: americano, price: "4800" },
      { name: "시그니처 자몽티", image: housechoco, price: "4800" },
      { name: "시그니처 레몬티", image: vanillalatte, price: "4800" },
      { name: "보성 말차라떼", image: housecream, price: "4800" },
    ],
  },
  {
    id: 4,
    ...
    menu: [
      { name: "아메리카노 H,L", image: coldbrew, price: "4000" },
      { name: "에스프레소", image: cappuccino, price: "4000" },
      { name: "스페니쉬 연유 라떼", image: flatwhite, price: "4800" },
      { name: "카페라떼", image: housedolce, price: "4500" },
      { name: "밀크티", image: einspanner, price: "6000" },
      { name: "자몽차", image: caffelatte, price: "6000" },
      { name: "카모마일", image: housematcha, price: "6000" },
    ],
  },
  {
    id: 5,
    ...
    menu: [
      { name: "매화", image: coldbrew, price: "9000" },
      { name: "흑심", image: cappuccino, price: "8000" },
      { name: "블랙큐브라떼", image: flatwhite, price: "8000" },
      { name: "짙어지다-말차", image: housedolce, price: "8000" },
      { name: "아이리쉬 커피", image: einspanner, price: "9000" },
      { name: "뱅쇼", image: caffelatte, price: "9000" },
      { name: "베일리스 모카", image: housematcha, price: "9000" },
      { name: "아인슈페너", image: coldbrew, price: "6500" },
      { name: "아메리카노", image: cappuccino, price: "5000" },
    ],
  ...
  },
  {
    ...
    menu: [
      { name: "아메리카노", image: coldbrew, price: "4500" },
      { name: "일랑일랑", image: cappuccino, price: "6500" },
      { name: "모호라떼", image: flatwhite, price: "5500" },
      { name: "모호크림", image: housedolce, price: "6500" },
      { name: "리얼바닐라라떼", image: einspanner, price: "6000" },
      { name: "카페라떼", image: caffelatte, price: "5500" },
      { name: "와일드베리 에이드", image: housematcha, price: "6500" },
      { name: "싸니 시트러스 펀치", image: coldbrew, price: "6000" },
      { name: "키위머스킷 아이스티", image: cappuccino, price: "7000" },
    ],
  },
  {
    id: 7,
    ...
    menu: [
      { name: "카페 알롱제", image: coldbrew, price: "4000" },
      { name: "아메리카노", image: cappuccino, price: "5500" },
      { name: "카페라떼", image: flatwhite, price: "6000" },
      { name: "플랫화이트", image: housedolce, price: "6500" },
      { name: "에스프레소 마끼아또", image: einspanner, price: "4500" },
      { name: "콜드브루", image: caffelatte, price: "6000" },
      { name: "몽블랑", image: housematcha, price: "8000" },
      { name: "필터 크랑크뤼", image: coldbrew, price: "9000" },
      { name: "초콜릿 라떼", image: cappuccino, price: "6000" },
      { name: "홍차 얼그레이", image: cappuccino, price: "6000" },
    ],
  },
  {
    id: 8,
    ...
    menu: [
      { name: "브리즈라떼", image: coldbrew, price: "6500" },
      { name: "브리즈베리", image: cappuccino, price: "6500" },
      { name: "알룰로스 토마토 주스", image: flatwhite, price: "7000" },
      { name: "아메리카노", image: housedolce, price: "4500" },
      { name: "카페라떼", image: einspanner, price: "5500" },
    ],
  },
  {
    id: 9,
    ...
    menu: [
      { name: "아메리카노", image: coldbrew, price: "4500" },
      { name: "카페라떼", image: cappuccino, price: "5000" },
      { name: "스노우 핫초코", image: flatwhite, price: "5500" },
      { name: "크림 라떼", image: housedolce, price: "6000" },
      { name: "카페 비엔나", image: einspanner, price: "6000" },
      { name: "고구마 라떼", image: coldbrew, price: "6500" },
      { name: "레몬 모히또", image: cappuccino, price: "7500" },
      { name: "예뻐지는 주스(오렌지+파인애플 생과일 주스)", image: flatwhite, price: "8500" },
    ],
  },
  {
    id: 10,
    ...
    menu: [
      { name: "에스프레소", image: coldbrew, price: "4300" },
      { name: "아메리카노", image: cappuccino, price: "4300" },
      { name: "카페라떼", image: flatwhite, price: "4800" },
      { name: "바닐라라떼", image: housedolce, price: "5300" },
      { name: "토피넛라떼", image: einspanner, price: "5300" },
      { name: "달달크림초코", image: coldbrew, price: "5300" },
      { name: "얼그레이", image: cappuccino, price: "4800" },
      { name: "캐모마일", image: flatwhite, price: "4800" },
      { name: "페퍼민트", image: einspanner, price: "4800" },
      { name: "레몬 아이스티", image: coldbrew, price: "4800" },
      { name: "유자애플티", image: cappuccino, price: "5300" },
      { name: "자몽티", image: flatwhite, price: "5300" },
      { name: "밀크땅콩", image: flatwhite, price: "4800" },
    ],
